...
@property (weak, nonatomic) IBOutlet UIImageView *obstTop;
@property (weak, nonatomic) IBOutlet UIImageView *obstBot;

@property (weak, nonatomic) IBOutlet UIImageView *obst;
@property (weak, nonatomic) IBOutlet UIImageView *obst2;
...
@property (weak, nonatomic) IBOutlet UIImageView *top7;
...
@property (weak, nonatomic) IBOutlet UIImageView *bottom7;
